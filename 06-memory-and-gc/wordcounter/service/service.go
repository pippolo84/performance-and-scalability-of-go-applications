...
import (
	"encoding/json"
	"net/http"
	"performance-and-scalability-of-go-applications/06-memory-and-gc/wordcounter/social"
	"performance-and-scalability-of-go-applications/06-memory-and-gc/wordcounter/wfreq"
	"strconv"
)
